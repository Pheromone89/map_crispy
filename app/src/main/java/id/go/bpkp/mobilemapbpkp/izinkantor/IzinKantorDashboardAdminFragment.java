...
public class IzinKantorDashboardAdminFragment extends Fragment {
    ...
    private CardView
            daftarPegawaiIzinKantorView;

    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_izin_kantor_dashboard_admin, null);
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        ((AppCompatActivity) getActivity()).getSupportActionBar().setTitle(R.string.title_fragment_izin_kantor_dashboard_admin);
    ...
    private void initiateView() {
        daftarPegawaiIzinKantorView = rootView.findViewById(R.id.dashboard_izin_kantor_daftar_pegawai_button);
    }
    ...
    private void initiateSetOnClickMethod() {
        daftarPegawaiIzinKantorView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ...
                fragment = new IzinKantorDaftarPegawaiFragment();
