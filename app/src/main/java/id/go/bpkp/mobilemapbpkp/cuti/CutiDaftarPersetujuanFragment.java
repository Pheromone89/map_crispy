...
public class CutiDaftarPersetujuanFragment extends Fragment implements RecyclerViewClickListener {
    ...
    private BawahanLangsungCutiAdapter
            pegawaiBawahanLangsungAdapter;
    private List<BawahanLangsungCuti>
            pegawaiBawahanLangsungList;
    private ProgressBar loadingProgressBar;

    public CutiDaftarPersetujuanFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_cuti_bawahan_langsung, null);
    }
...
//        previousTitle = ((AppCompatActivity)getActivity()).getSupportActionBar().getTitle().toString();
    ...
    private void initiateView() {
        loadingProgressBar = rootView.findViewById(R.id.cuti_bawahan_langsung_progress_bar);
        pegawaiBawahanLangsungRecyclerView = (RecyclerView) rootView.findViewById(R.id.recycler_view_cuti_bawahan_langsung);
    ...
    private void populateView() {
        pegawaiBawahanLangsungAdapter = new BawahanLangsungCutiAdapter(getActivity(), pegawaiBawahanLangsungList, this, mNipLama, mUserToken);
...
//                loading.dismiss();
            ...
            protected String doInBackground(Void... params) {
                ...
                String s = rh.sendGetRequest(konfigurasi.URL_GET_EMP_CUTIBAWAHANLANGSUNG + mNipLama + "?api_token=" + mUserToken);
                return s;
            }
        }
