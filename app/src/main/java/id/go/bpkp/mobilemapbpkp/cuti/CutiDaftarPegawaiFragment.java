...
public class CutiDaftarPegawaiFragment extends Fragment implements RecyclerViewClickListener {
    ...
    private RecyclerView
            pegawaiCutiRecyclerView;
    private PegawaiCutiAdapter
            pegawaiCutiAdapter;
    private List<PegawaiCuti>
            pegawaiCutiList;
    private ProgressBar loadingProgressBar;

    public CutiDaftarPegawaiFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_cuti_seluruh_pegawai, null);
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        pegawaiCutiList = new ArrayList<>();

        initiateView();
        getJSON();

//        previousTitle = ((AppCompatActivity)getActivity()).getSupportActionBar().getTitle().toString();
        ((AppCompatActivity) getActivity()).getSupportActionBar().setTitle(R.string.title_fragment_cuti_seluruh_pegawai);
    }
    ...
    private void initiateView() {
        loadingProgressBar = rootView.findViewById(R.id.cuti_seluruh_pegawai_progress_bar);
        pegawaiCutiRecyclerView = (RecyclerView) rootView.findViewById(R.id.recycler_view_cuti_seluruh_pegawai);
        pegawaiCutiRecyclerView.setHasFixedSize(true);
        pegawaiCutiRecyclerView.setLayoutManager(new LinearLayoutManager(getActivity()));
    }

    private void populateView() {
        pegawaiCutiAdapter = new PegawaiCutiAdapter(getActivity(), pegawaiCutiList, this, mUserToken);
        pegawaiCutiRecyclerView.setAdapter(pegawaiCutiAdapter);
    }
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        ...
        SearchView.OnQueryTextListener queryTextListener = new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String query) {
                ...
                CutiDaftarPegawaiFragment fragment = new CutiDaftarPegawaiFragment();
    ...
    private void getJSON() {
        class GetJSON extends AsyncTask<Void, Void, String> {
            ...
            protected void onPreExecute() {
                ...
                pegawaiCutiRecyclerView.setVisibility(View.GONE);
//                loading = ProgressDialog.show(getActivity(),null,null,false,false);
            ...
            protected void onPostExecute(String s) {
                ...
                pegawaiCutiRecyclerView.setVisibility(View.VISIBLE);
//                loading.dismiss();
                JSON_STRING = s;
                parseJSON();
            }
