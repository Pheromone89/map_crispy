...
//
//    public static Intent loginIntentTest(
//            Context context,
...
//    }
    ...
    public static Intent loginIntent(
        ...
        try {
            ...
            // test saved instance
            SavedInstances.loginId = username;
            SavedInstances.loginPassword = password;
            SavedInstances.userToken = jsonObject.getString("api_token");
            SavedInstances.id = jsonObject.getJSONObject("message").getString("id");
            SavedInstances.name = jsonObject.getJSONObject("message").getString("name");
            SavedInstances.email = jsonObject.getJSONObject("message").getString("email");
            SavedInstances.username = jsonObject.getJSONObject("message").getString("username");
            SavedInstances.roleId = Integer.parseInt(jsonObject.getJSONObject("message").getString("role_id"));
            SavedInstances.nipLama = jsonObject.getJSONObject("message").getString("user_nip");
            SavedInstances.nomorHp = jsonObject.getJSONObject("message").getString("nomorhp");
            SavedInstances.keySortUnit = jsonObject.getJSONObject("message").getString("key_sort_unit");
            SavedInstances.nipBaru = jsonObject.getJSONObject("message").getString("nipbaru");
            SavedInstances.isLdap = jsonObject.getJSONObject("message").getString("is_ldap");
            SavedInstances.isJab = jsonObject.getJSONObject("message").getString("is_jab");
            SavedInstances.version = jsonObject.getJSONObject("message").getString("version");
            SavedInstances.isHut = jsonObject.getJSONObject("message").getString("is_hut");
            SavedInstances.urlFoto = jsonObject.getJSONObject("message").getString("url_foto");
            SavedInstances.isAtasan = jsonObject.getJSONObject("message").getString("is_atasan");
            SavedInstances.imei = imei;
            ...
            editor.putString(FragmentBundles.BUNDLE_URLFOTO_MESSAGE, fotoUrl);
